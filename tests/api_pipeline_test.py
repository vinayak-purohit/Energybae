"""
Full API pipeline test: uploads sample bill images to the /api/generate-proposal endpoint
...
# Step 4: Check Content-Disposition (download filename)
cd = r.headers.get('Content-Disposition', '')
print(f"\n[4/5] Download header: {cd}")

# Step 5: Save and verify Excel
